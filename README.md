...
K2 resident reference; E1 comparator stays a separate model profile. The shared HaloClu guide below describes the common frontend; it is not a new qualification of this model.
