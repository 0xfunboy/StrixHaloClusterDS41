...
export DS41_ENGRAM_READ_WORKERS="${DS41_ENGRAM_READ_WORKERS:-4}"
export DS41_ENGRAM_PARALLEL_MIN_ROWS="${DS41_ENGRAM_PARALLEL_MIN_ROWS:-256}"
[[ "$DS41_ENGRAM_RANDOM_ADVICE" == 0 || "$DS41_ENGRAM_RANDOM_ADVICE" == 1 ]] || { echo 'invalid DS41_ENGRAM_RANDOM_ADVICE' >&2; exit 2; }
[[ "$DS41_ENGRAM_READ_WORKERS" =~ ^[1-8]$ ]] || { echo 'invalid DS41_ENGRAM_READ_WORKERS' >&2; exit 2; }
[[ "$DS41_ENGRAM_PARALLEL_MIN_ROWS" =~ ^[1-9][0-9]*$ ]] || { echo 'invalid DS41_ENGRAM_PARALLEL_MIN_ROWS' >&2; exit 2; }
...
export DS41_REPEAT_DIAG_DIR="${DS41_REPEAT_DIAG_DIR:-}"
export DS41_REPEAT_DIAG_PROMPT_TOKENS="${DS41_REPEAT_DIAG_PROMPT_TOKENS:-1588}"
export DS41_REPEAT_DIAG_MAX_REQUESTS="${DS41_REPEAT_DIAG_MAX_REQUESTS:-2}"
export DS41_REPEAT_DIAG_MODE="${DS41_REPEAT_DIAG_MODE:-full}"
export DS41_CANONICAL_PREFILL_TOPK="${DS41_CANONICAL_PREFILL_TOPK:-0}"
export DS41_DS4_MMQ_PREFILL="${DS41_DS4_MMQ_PREFILL:-0}"
export DS41_DS4_MMQ_LIB="${DS41_DS4_MMQ_LIB:-$ROOT/runtime/ds41/lib/libds41-ds4-moe.so}"
export DS41_DS4_MMQ_MIN_TOKENS="${DS41_DS4_MMQ_MIN_TOKENS:-128}" DS41_DS4_MMQ_MAX_TOKENS="${DS41_DS4_MMQ_MAX_TOKENS:-1024}"
if [[ "$DS41_DS4_MMQ_PREFILL" == 1 ]]; then [[ -f "$DS41_DS4_MMQ_LIB" ]] || { echo "missing DS41 DS4 MMQ library: $DS41_DS4_MMQ_LIB" >&2; exit 2; }; fi
export DS41_DECODE_TRACE_DIR="${DS41_DECODE_TRACE_DIR:-}"
export DS41_DECODE_TRACE_PROMPT_TOKENS="${DS41_DECODE_TRACE_PROMPT_TOKENS:-1588}"
export DS41_DECODE_TRACE_MAX_REQUESTS="${DS41_DECODE_TRACE_MAX_REQUESTS:-2}"
export DS41_DECODE_TRACE_EMIT_CAP="${DS41_DECODE_TRACE_EMIT_CAP:-40}"
