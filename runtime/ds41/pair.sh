...
start_unit_local() {
  ...
  systemd-run --user --unit=ds41-rank0 --collect \
    ...
    --setenv="DS41_REAL_DSPARK_K=${DS41_REAL_DSPARK_K:-}" --setenv="DS41_ENGRAM_RANDOM_ADVICE=${DS41_ENGRAM_RANDOM_ADVICE:-1}" --setenv="DS41_ENGRAM_READ_WORKERS=${DS41_ENGRAM_READ_WORKERS:-4}" --setenv="DS41_ENGRAM_PARALLEL_MIN_ROWS=${DS41_ENGRAM_PARALLEL_MIN_ROWS:-256}" \
    ...
    --setenv="DS41_ROUTE_CAPTURE_DIR=${DS41_ROUTE_CAPTURE_DIR:-}" --setenv="DS41_ROUTE_CAPTURE_CALLS=${DS41_ROUTE_CAPTURE_CALLS:-0,20,40,60}" --setenv="DS41_ROUTE_CAPTURE_PROMPT_TOKENS=${DS41_ROUTE_CAPTURE_PROMPT_TOKENS:-1588}" --setenv="DS41_MOE_PREFILL_BLOCK_M=${DS41_MOE_PREFILL_BLOCK_M:-4}" \
    --setenv="DS41_REPEAT_DIAG_DIR=${DS41_REPEAT_DIAG_DIR:-}" --setenv="DS41_REPEAT_DIAG_PROMPT_TOKENS=${DS41_REPEAT_DIAG_PROMPT_TOKENS:-1588}" --setenv="DS41_REPEAT_DIAG_MAX_REQUESTS=${DS41_REPEAT_DIAG_MAX_REQUESTS:-2}" --setenv="DS41_REPEAT_DIAG_MODE=${DS41_REPEAT_DIAG_MODE:-full}" --setenv="DS41_CANONICAL_PREFILL_TOPK=${DS41_CANONICAL_PREFILL_TOPK:-0}" --setenv="DS41_DS4_MMQ_PREFILL=${DS41_DS4_MMQ_PREFILL:-0}" --setenv="DS41_DS4_MMQ_LIB=${DS41_DS4_MMQ_LIB:-}" --setenv="DS41_DS4_MMQ_MIN_TOKENS=${DS41_DS4_MMQ_MIN_TOKENS:-128}" --setenv="DS41_DS4_MMQ_MAX_TOKENS=${DS41_DS4_MMQ_MAX_TOKENS:-1024}" --setenv="DS41_DECODE_TRACE_DIR=${DS41_DECODE_TRACE_DIR:-}" --setenv="DS41_DECODE_TRACE_PROMPT_TOKENS=${DS41_DECODE_TRACE_PROMPT_TOKENS:-1588}" --setenv="DS41_DECODE_TRACE_MAX_REQUESTS=${DS41_DECODE_TRACE_MAX_REQUESTS:-2}" --setenv="DS41_DECODE_TRACE_EMIT_CAP=${DS41_DECODE_TRACE_EMIT_CAP:-40}" \
...
cmd_start() {
  ...
  [[ "${DS41_ENGRAM_READ_WORKERS:-4}" =~ ^[1-8]$ ]] || { echo 'invalid DS41_ENGRAM_READ_WORKERS' >&2; exit 2; }
  [[ "${DS41_ENGRAM_PARALLEL_MIN_ROWS:-256}" =~ ^[1-9][0-9]*$ ]] || { echo 'invalid DS41_ENGRAM_PARALLEL_MIN_ROWS' >&2; exit 2; }
  acquire_control
