...
start_unit_local() {
  ...
  systemd-run --user --unit=ds41-rank0 --collect \
    ...
    --setenv="DS41_REPEAT_DIAG_DIR=${DS41_REPEAT_DIAG_DIR:-}" --setenv="DS41_REPEAT_DIAG_PROMPT_TOKENS=${DS41_REPEAT_DIAG_PROMPT_TOKENS:-1588}" --setenv="DS41_REPEAT_DIAG_MAX_REQUESTS=${DS41_REPEAT_DIAG_MAX_REQUESTS:-2}" \
